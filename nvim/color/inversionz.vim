...
hi! Normal       ctermfg=254 ctermbg=234 cterm=NONE guifg=#e4e4e4 guibg=#272727 gui=NONE
...
hi! StorageClass ctermfg=147 ctermbg=NONE cterm=bold guifg=#af5fff guibg=NONE gui=bold
hi! Structure    ctermfg=147 ctermbg=NONE cterm=NONE guifg=#af5fff guibg=NONE gui=NONE
...
" #d7005f 161 lowRed 
hi! Special      ctermfg=161 ctermbg=NONE cterm=NONE guifg=#8700ff guibg=NONE gui=NONE
hi! SpecialChar  ctermfg=161 ctermbg=NONE cterm=NONE guifg=#8700ff guibg=NONE gui=NONE
hi! MatchParen   ctermfg=161 ctermbg=NONE cterm=bold guifg=#8700ff guibg=NONE gui=bold
hi! Todo         ctermfg=161 ctermbg=NONE cterm=NONE guifg=#8700ff guibg=NONE gui=NONE

" }}}

" Special Highlight Assignments {{{
" Error/Warning
hi! Error     ctermfg=000 ctermbg=168 cterm=NONE guifg=#000000 guibg=#8700ff gui=NONE
hi! ErrorMsg     ctermfg=000 ctermbg=168 cterm=NONE guifg=#000000 guibg=#8700ff gui=NONE
hi! WarningMsg   ctermfg=000 ctermbg=049 cterm=NONE guifg=#000000 guibg=#8700ff gui=NONE
hi! NvimInternalError     ctermfg=000 ctermbg=168 cterm=NONE guifg=#000000 guibg=#8700ff gui=NONE
...
"  Line
hi! StatusLine   ctermfg=232 ctermbg=136 cterm=bold guifg=#080808 guibg=#8700ff gui=bold
hi! StatusLineNC ctermfg=232 ctermbg=242 cterm=NONE guifg=#080808 guibg=#6c6c6c gui=NONE
hi! MsgArea      ctermfg=NONE ctermbg=236 cterm=NONE guifg=NONE guibg=#272727 gui=NONE
...
hi! CursorLine   ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#1c1c1c gui=NONE
hi! CursorLineNr ctermfg=136 ctermbg=16 cterm=bold guifg=#8700ff guibg=#1c1c1c gui=bold
hi! CursorLineSign ctermfg=NONE ctermbg=16 cterm=bold guifg=NONE guibg=#1c1c1c gui=bold
hi! CursorColumn ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#01c1c1c gui=NONE
...
hi! Cursor       ctermfg=232 ctermbg=136 cterm=NONE guifg=#080808 guibg=#7711ff gui=NONE
