...
"hi! Normal       ctermfg=254 ctermbg=234 cterm=NONE guifg=#e4e4e4 guibg=#000000 gui=NONE
...
hi! Keyword      ctermfg=147 ctermbg=NONE cterm=NONE guifg=#e4e4e4 guibg=NONE gui=NONE
hi! Character    ctermfg=147 ctermbg=NONE cterm=NONE guifg=#e4e4e4 guibg=NONE gui=NONE
hi! StorageClass ctermfg=147 ctermbg=NONE cterm=bold guifg=#0000ff guibg=NONE gui=bold
hi! Structure    ctermfg=147 ctermbg=NONE cterm=NONE guifg=#0000ff guibg=NONE gui=NONE
hi! Operator     ctermfg=147 ctermbg=NONE cterm=bold guifg=#e4e4e4 guibg=NONE gui=bold

" #af5fff 135 lowPurple
hi! Type         ctermfg=135 ctermbg=NONE cterm=bold guifg=#0000ff guibg=NONE gui=bold
...
"
" #00d7d7 044 lowGreen
hi! Define       ctermfg=44 ctermbg=NONE cterm=NONE guifg=#e4e4e4 guibg=NONE gui=NONE
hi! PreProc      ctermfg=44 ctermbg=NONE cterm=NONE guifg=#e4e4e4 guibg=NONE gui=NONE
hi! Label        ctermfg=44 ctermbg=NONE cterm=NONE guifg=#e4e4e4 guibg=NONE gui=NONE
hi! Conditional  ctermfg=44 ctermbg=NONE cterm=NONE guifg=#e4e4e4 guibg=NONE gui=NONE
hi! Statement    ctermfg=44 ctermbg=NONE cterm=NONE guifg=#e4e4e4 guibg=NONE gui=NONE
hi! Question     ctermfg=44 ctermbg=NONE cterm=NONE guifg=#e4e4e4 guibg=NONE gui=NONE

" #d75f87 168 highRed  
hi! Debug        ctermfg=168 ctermbg=NONE cterm=NONE guifg=#d75f87 guibg=NONE gui=NONE

" #d7005f 161 lowRed 
hi! Special      ctermfg=161 ctermbg=NONE cterm=NONE guifg=#0000ff guibg=NONE gui=NONE
hi! SpecialChar  ctermfg=161 ctermbg=NONE cterm=NONE guifg=#0000ff guibg=NONE gui=NONE
hi! MatchParen   ctermfg=161 ctermbg=NONE cterm=bold guifg=#0000ff guibg=NONE gui=bold
hi! Todo         ctermfg=161 ctermbg=NONE cterm=NONE guifg=#0000ff guibg=NONE gui=NONE

" }}}

" Special Highlight Assignments {{{
" Error/Warning
hi! Error     ctermfg=000 ctermbg=168 cterm=NONE guifg=#000000 guibg=#ff0000 gui=NONE
hi! ErrorMsg     ctermfg=000 ctermbg=168 cterm=NONE guifg=#000000 guibg=#ff0000 gui=NONE
hi! WarningMsg   ctermfg=000 ctermbg=049 cterm=NONE guifg=#000000 guibg=#ff0000 gui=NONE
hi! NvimInternalError     ctermfg=000 ctermbg=168 cterm=NONE guifg=#000000 guibg=#ff0000 gui=NONE
...
hi! DiffText     ctermfg=220 ctermbg=NONE cterm=NONE guifg=#0000ff guibg=NONE gui=NONE
...
hi! CursorLine   ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#080808 gui=NONE
hi! CursorLineNr ctermfg=136 ctermbg=16 cterm=bold guifg=#0000ff guibg=#080808 gui=bold
hi! CursorLineSign ctermfg=NONE ctermbg=16 cterm=bold guifg=NONE guibg=#080808 gui=bold
hi! CursorColumn ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#080808 gui=NONE
hi! SignColumn   ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE

"  Select
hi! Visual       ctermfg=NONE ctermbg=232 cterm=NONE guifg=NONE guibg=#1c1c1c gui=NONE
...
hi! TabLine      ctermfg=245 ctermbg=237 cterm=NONE guifg=#000000 guibg=#383838 gui=NONE
...
" # Markdown
hi! markdownHeadingDelimiter ctermfg=161 ctermbg=NONE cterm=NONE guifg=#0000ff guibg=NONE gui=NONE
" # HTML
...
hi! RedrawDebugClear ctermfg=Black ctermbg=Blue cterm=NONE guifg=Black guibg=Blue gui=NONE 
